    ...
    return (
        <SafeAreaView className="flex-1 items-start justify-center bg-[#F3E05F]">
            ...
            <View className="absolute top-[50px] left-[26px]">
                <Animatable.Text animation="fadeInLeft" duration={1000} style={{ paddingVertical: 6, paddingHorizontal: 15, fontFamily: "PoppinsSemiBold" }} className="bg-white rounded-[10px] text-[#3A3A3A] text-[14px] leading-[21px]">Total Body</Animatable.Text>
            </View>
